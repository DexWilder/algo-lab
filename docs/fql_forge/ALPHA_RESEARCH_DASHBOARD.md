# ALPHA RESEARCH DASHBOARD (auto-generated 2026-07-06 19:28 UTC)
...
- Guardrails: **clean/P1** | Self-audit: **SELF_AUDIT_CLEAN** (facets=12 PASS=12 STALE=0 BROKEN=0 DESIGNED-not-built=0) | Git backlog: **0** | Global trial-N: **1854**
...
- Tests logged today: **29** | total kills: 6 | screen-passes: 2
...
- Items: **58** | NEW: 0 | P0/P1: 11/31 | source packets today: 7
...
## Queue depth
- RUN_NOW: 23 | total queue items: 81
