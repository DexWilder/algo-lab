# ALPHA RESEARCH DASHBOARD (auto-generated 2026-07-07 16:58 UTC)
...
- Guardrails: **clean/P1** | Self-audit: **SELF_AUDIT_CLEAN** (facets=12 PASS=12 STALE=0 BROKEN=0 DESIGNED-not-built=0) | Git backlog: **0** | Global trial-N: **3021**
- **Mission:** MNQ/MES/MYM index workhorse (WH1). RUN_NOW mission-weighting: 30/42 WH1-aligned ({'DIVERSIFIER': 12, 'INDEX_REGIME_INPUT': 27, 'INDEX_DIRECT': 3})
...
- Tests logged today: **1167** | total kills: 15 | screen-passes: 2
...
- **DISCOVERY layer:** mechanisms in library **85** (Tier-A: 82) | tested 26 | **discovery surface (untested Tier-A): 52** | goal: 100s — grow every week
...
- **LIFECYCLE (nothing sits):** {'Retired': 23, 'Validated': 3, 'Blocked': 16, 'Harvested': 43} — every mechanism is Harvested/Testing/Validated/Retired
...
## Queue depth
- RUN_NOW: 42 | total queue items: 108
