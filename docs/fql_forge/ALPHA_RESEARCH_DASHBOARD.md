# ALPHA RESEARCH DASHBOARD (auto-generated 2026-07-01 17:11 UTC)
...
- Guardrails: **clean/P1** | Git backlog: **0** | Test scripts run: 200 | Global trial-N: **1783**
...
- Families: **13 active** / 20 | coverage 52% (tested exprs / total exprs)
- Candidate ladder: SCREEN_PASS=1

## Inbound capture (organizational memory — nothing floats)
- Items: **24** | NEW: 0 | P0/P1: 4/14 | source packets today: 0
- Untriaged directives: 0 | mistakes w/o control: **1** ['INB-20260625-002'] | unused feeds: 0
...
## Queue depth
- RUN_NOW: 3 | total queue items: 36
...
[P1] INBOUND: 1 mistake/validation item(s) with NO durable control: ['INB-20260625-002'] (no control = not fixed)
