# ALPHA RESEARCH DASHBOARD (auto-generated 2026-07-07 21:13 UTC)
...
- Guardrails: **clean/P1** | Self-audit: **SELF_AUDIT_CLEAN** (facets=12 PASS=12 STALE=0 BROKEN=0 DESIGNED-not-built=0) | Git backlog: **0** | Global trial-N: **3027**
...
- Tests logged today: **1173** | total kills: 20 | screen-passes: 2
...
- **VALIDATION layer:** candidate COMPONENTS **5** (spreadMR_GC · GEX-ingredient · month-end-WATCH) — NOT established engines; each still needs full validation. Validated primaries: 0
- **LIFECYCLE (nothing sits):** {'Retired': 26, 'Validated': 3, 'Blocked': 18, 'Harvested': 37, 'Testing': 2} — every mechanism is Harvested/Testing/Validated/Retired
