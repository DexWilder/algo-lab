# ALPHA RESEARCH DASHBOARD (auto-generated 2026-07-07 01:08 UTC)
...
- Guardrails: **clean/P1** | Self-audit: **SELF_AUDIT_CLEAN** (facets=12 PASS=12 STALE=0 BROKEN=0 DESIGNED-not-built=0) | Git backlog: **0** | Global trial-N: **1856**
...
- Items: **59** | NEW: 0 | P0/P1: 11/32 | source packets today: 0
...
## Queue depth
- RUN_NOW: 23 | total queue items: 82
