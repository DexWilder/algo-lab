# ALPHA RESEARCH DASHBOARD (auto-generated 2026-07-08 16:33 UTC)
...
- Guardrails: **clean/P1** | Self-audit: **SELF_AUDIT_CLEAN** (facets=12 PASS=12 STALE=0 BROKEN=0 DESIGNED-not-built=0) | Git backlog: **0** | Global trial-N: **3035**
...
- Tests logged today: **8** | total kills: 25 | screen-passes: 2
...
- **LIFECYCLE (nothing sits):** {'Retired': 31, 'Validated': 2, 'Archived': 11, 'Harvested': 35, 'Blocked': 7, 'PaperCandidate': 1} — every mechanism is Harvested/Testing/Validated/Retired
