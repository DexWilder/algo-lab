...
- **NEXT:** sleeve-addition/decorrelation test of first_impulse_pullback|ema_slope|profit_ladder vs orb_breakout book on MNQ (overlap, pairwise corr, combined per-year DD, bad-day offset). Report-only. Then param-neighborhood robustness if it adds value.
