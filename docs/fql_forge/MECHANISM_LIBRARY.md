...
- **XSMOM (24o) → SCREEN_PASS (promising, strongest standalone non-ORB lead; cost-gated).** Cross-sectional rank long-top2/short-bottom2 on 5 micros (equity-heavy 3/5), weekly rebal, 2bps/day proxy. **lb21: Sharpe 1.55, PF 1.35, +16.2bps/day, 6/6 yrs, corr-to-ORB 0.119, corr-to-TSMOM 0.218 (decorrelated from BOTH → potential 3rd regime), PSR 0.9999.** lb63 0.60 / lb126 0.26 (monotonic decay → short-horizon effect, likely commodity-vs-equity relative + short-term-reversal flavored). HELD at SCREEN_PASS — #1 risk is COST (turnover-heavy 4-leg weekly rebal; 2bps/day proxy optimistic). Full audit (turnover cost stress + gates + DSR-dispersion) running (24-xsa).
