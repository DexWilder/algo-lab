# Opening Range Breakout Scripts

**Roster Target**: ALGO-CORE-ORB-001
...
2. **Futures Fit** (20%) -- Does the logic apply to MES/MNQ futures on 1m/3m/5m?
...
- Opening range definition must be explicit (fixed time window, not adaptive)
