"""ORB_EMA_TREND — ORB-009 + EMA alignment confirmation on breakout direction.
...
import pandas as pd
import numpy as np
from research.evolution.mutations import compute_ema_alignment
...
def generate_signals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df.drop(columns=["_date", "or_high", "or_low", "or_range", "vwap", "vol_ma", "ema_aligned_long", "ema_aligned_short"], inplace=True, errors="ignore")
