"""ORB_MOMENTUM_CONFIRM — ORB-009 + ORB + BBKC momentum direction: long only when lime, short only when red.
...
def generate_signals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df.drop(columns=["_date", "or_high", "or_low", "or_range", "vwap", "vol_ma", "mom_lime", "mom_green", "mom_red", "mom_maroon"], inplace=True, errors="ignore")
