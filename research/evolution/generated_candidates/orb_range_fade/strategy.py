"""ORB_RANGE_FADE — ORB-009 + Range fade filter (fade range boundaries after OR).
...
import pandas as pd
import numpy as np
from research.evolution.mutations import compute_range_fade
...
def generate_signals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df.drop(columns=["_date", "or_high", "or_low", "or_range", "vwap", "vol_ma", "range_fade_long", "range_fade_short", "in_range"], inplace=True, errors="ignore")
