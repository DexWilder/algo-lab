"""ORB_RELAXED_ENTRY — ORB-009 with relaxed filters.
...
CANDLE_STRENGTH = 0.45    # Close in top/bottom 30% of range
...
def generate_signals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df.drop(columns=["_date", "or_high", "or_low", "or_range", "vwap", "vol_ma"], inplace=True, errors="ignore")
