"""ORB_SQUEEZE_FILTER — ORB-009 + ORB + BBKC squeeze release gate: only enter breakout on squeeze release events.
...
def generate_signals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df.drop(columns=["_date", "or_high", "or_low", "or_range", "vwap", "vol_ma", "squeeze_on", "squeeze_release"], inplace=True, errors="ignore")
