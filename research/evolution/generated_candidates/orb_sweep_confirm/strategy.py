"""ORB_SWEEP_CONFIRM — ORB-009 + ORB + ICT sweep confirmation: long only after low sweep, short only after high sweep.
...
import pandas as pd
import numpy as np
from research.evolution.mutations import compute_sweep
...
def generate_signals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df.drop(columns=["_date", "or_high", "or_low", "or_range", "vwap", "vol_ma", "sweep_bias"], inplace=True, errors="ignore")
