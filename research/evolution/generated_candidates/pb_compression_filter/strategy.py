"""PB_COMPRESSION_FILTER — PB Trend + PB + ORION compression pre-filter: only enter pullback in compression zones.
...
def generate_signals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Final signals
    long_signal = df["allowed"] & quality_ok & trend_regime & pb_long & df["compression_active"]
    short_signal = df["allowed"] & quality_ok & trend_regime & pb_short & df["compression_active"]
