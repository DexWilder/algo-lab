"""PB_SQUEEZE_FILTER — PB Trend + PB + BBKC squeeze release gate: only enter pullback on squeeze release.
...
import pandas as pd
import numpy as np
from research.evolution.mutations import compute_squeeze
...
def generate_signals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Final signals
    long_signal = df["allowed"] & quality_ok & trend_regime & pb_long & df["squeeze_release"]
    short_signal = df["allowed"] & quality_ok & trend_regime & pb_short & df["squeeze_release"]
