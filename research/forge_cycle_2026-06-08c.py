"""Cycle 2026-06-08c — Non-ORB Packet #2 hunt.

Per operator directive 2026-06-08:
  "Pivot away from ORB-family diagnostics. Packet #2 hunt should move toward
   genuinely new edges."

Priority categories targeted this cycle:
  - Cat 1: Non-ORB MCL/MGC entries (pb_pullback, bb_reversion, vwap_continuation,
    prior_day_fade with ema_slope + profit_ladder)
  - Cat 5: Donchian + session_close / session_afternoon on MCL/MGC

Boundaries: report-only Lane B. Every WATCH gets prop-stress immediately.
Stress fail = OBSERVATIONAL. Median-negative PF>1.2 = KILL.
"""
...
# Non-ORB Packet #2 hunt — 18 candidates
SPECS = [
    # Cat 1a: pb_pullback on MCL/MGC
    {"label": "P2H-PB-MCL-Long-PL", "asset": "MCL", "entry": "pb_pullback",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-PB-MCL-Short-PL", "asset": "MCL", "entry": "pb_pullback",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "short"},
    {"label": "P2H-PB-MGC-Long-PL", "asset": "MGC", "entry": "pb_pullback",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-PB-MGC-Short-PL", "asset": "MGC", "entry": "pb_pullback",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "short"},

    # Cat 1b: bb_reversion on MCL/MGC
    {"label": "P2H-BB-MCL-Long-PL", "asset": "MCL", "entry": "bb_reversion",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-BB-MCL-Short-PL", "asset": "MCL", "entry": "bb_reversion",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "short"},
    {"label": "P2H-BB-MGC-Long-PL", "asset": "MGC", "entry": "bb_reversion",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-BB-MGC-Short-PL", "asset": "MGC", "entry": "bb_reversion",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "short"},

    # Cat 1c: vwap_continuation on MCL/MGC
    {"label": "P2H-VWAP-MCL-Long-PL", "asset": "MCL", "entry": "vwap_continuation",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-VWAP-MCL-Short-PL", "asset": "MCL", "entry": "vwap_continuation",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "short"},
    {"label": "P2H-VWAP-MGC-Long-PL", "asset": "MGC", "entry": "vwap_continuation",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-VWAP-MGC-Short-PL", "asset": "MGC", "entry": "vwap_continuation",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "short"},

    # Cat 1d: prior_day_fade on MCL/MGC (mean-revert against prior day)
    {"label": "P2H-PDF-MGC-Long-PL", "asset": "MGC", "entry": "prior_day_fade",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-PDF-MGC-Short-PL", "asset": "MGC", "entry": "prior_day_fade",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "short"},

    # Cat 5: donchian + session_close on MCL/MGC (last-hour breakouts)
    {"label": "P2H-DC-CLOSE-MGC-Long-PL", "asset": "MGC", "entry": "donchian_breakout",
     "filter": "session_close", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-DC-CLOSE-MGC-Short-PL", "asset": "MGC", "entry": "donchian_breakout",
     "filter": "session_close", "exit": "profit_ladder", "mode": "short"},
    {"label": "P2H-DC-CLOSE-MCL-Long-PL", "asset": "MCL", "entry": "donchian_breakout",
     "filter": "session_close", "exit": "profit_ladder", "mode": "long"},
    {"label": "P2H-DC-CLOSE-MCL-Short-PL", "asset": "MCL", "entry": "donchian_breakout",
     "filter": "session_close", "exit": "profit_ladder", "mode": "short"},
]


def run():
    print(f"Cycle 2026-06-08c — Non-ORB Packet #2 hunt ({len(SPECS)} candidates)", flush=True)
    print(f"Categories: pb_pullback, bb_reversion, vwap_continuation, prior_day_fade, DC+session_close", flush=True)
    ...
    out = ROOT / "research" / "data" / "fql_forge" / "reports" / "forge_cycle_2026-06-08c.json"
    out.write_text(json.dumps({
        "date": date.today().isoformat(),
        "purpose": "Non-ORB Packet #2 hunt — pivot away from ORB-family diagnostics",
