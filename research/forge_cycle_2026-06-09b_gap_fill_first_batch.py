"""Cycle 2026-06-09b — gap_fill_trigger first batch.

Per operator decision #116 (build gap_fill_trigger). New primitive deployed
across 6 assets. PL-default per #91. Strict gates per #100/#102/#106.
...
SPECS = [
    {"label": "GAP-MES-Both-PL", "asset": "MES", "entry": "gap_fill_trigger",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "both"},
    {"label": "GAP-MNQ-Both-PL", "asset": "MNQ", "entry": "gap_fill_trigger",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "both"},
    {"label": "GAP-MYM-Both-PL", "asset": "MYM", "entry": "gap_fill_trigger",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "both"},
    {"label": "GAP-MGC-Both-PL", "asset": "MGC", "entry": "gap_fill_trigger",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "both"},
    {"label": "GAP-MCL-Both-PL", "asset": "MCL", "entry": "gap_fill_trigger",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "both"},
    {"label": "GAP-ZN-Both-PL", "asset": "ZN", "entry": "gap_fill_trigger",
     "filter": "ema_slope", "exit": "profit_ladder", "mode": "both"},
]


def run():
    print(f"Cycle 2026-06-09b — gap_fill_trigger first batch ({len(SPECS)} candidates)", flush=True)
    ...
    out = ROOT / "research" / "data" / "fql_forge" / "reports" / "forge_cycle_2026-06-09b.json"
    out.write_text(json.dumps({
        "date": date.today().isoformat(),
        "purpose": "gap_fill_trigger first batch (#116)",
        "boundaries": "report-only Lane B",
        "tier_classification": {
