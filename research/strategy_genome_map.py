...
STRATEGIES = [
    ...
    # ── Newly promoted probation (2026-03-15 harvest) ────────────────────────
    {
        "id": "NoiseBoundary-MNQ-Long",
        "name": "noise_boundary",
        "family": "breakout",
        "entry_type": "breakout",
        "entry_desc": "Noise boundary = Open * (1 + avg abs return * sqrt(tod)). Long on break above.",
        "asset": "MNQ",
        "side": "long",
        "hold_bars": 20,
        "hold_class": "swing",
        ...
        "portfolio_role": "core",
        "status": "probation",
        "exit_type": "VWAP trail + ATR backstop",
        "validation_score": 10.0,
        "param_stability": 100,
        "session": "all_day",
        "notes": "WF 10/10. Academic: Zarattini 2024. 609 trades, PF=1.28, Sharpe=1.40. Cross-asset on MES+MYM.",
        "primary_exposure": "volatility_expansion",
        "secondary_exposure": "trend_persistence",
        "volatility_dependency": "neutral",
        "trend_dependency": "trending",
    ...
    {
        "id": "RangeExpansion-MCL-Short",
        "name": "range_expansion",
        "family": "vol_expansion",
        "entry_type": "volatility_expansion",
        "entry_desc": "Range expansion detection → momentum entry on crude oil",
        "asset": "MCL",
        "side": "short",
        "hold_bars": 12,
        "hold_class": "swing",
        ...
        "portfolio_role": "core",
        "status": "probation",
        "exit_type": "ATR trail + target",
        "validation_score": 10.0,
        "param_stability": 100,
        "session": "all_day",
        "notes": "WF 10/10. MCL-short PF=1.46, Sharpe=2.39, 214 trades. First MCL strategy.",
        "primary_exposure": "volatility_expansion",
        "secondary_exposure": None,
        "volatility_dependency": "high",
        "trend_dependency": "trending",
    ...
    },
    {
        ...
        "family": "breakout",
        "entry_type": "breakout",
        "entry_desc": "Gap momentum — trade in direction of opening gap with momentum confirmation",
        "asset": "MGC",
        "side": "long",
        "hold_bars": 15,
        "hold_class": "swing",
        ...
        "param_stability": 83,
        "session": "morning",
        "notes": "WF 6.7/10. MGC-long PF=1.72, Sharpe=1.89, 74 trades. 83% window survival.",
        "primary_exposure": "gap_continuation",
        "secondary_exposure": "trend_persistence",
        "volatility_dependency": "neutral",
        "trend_dependency": "trending",
        "regime_dependency": "moderate",
    },
    {
        ...
        "family": "breakout",
        "entry_type": "breakout",
        "entry_desc": "Gap momentum — trade in direction of opening gap on NQ",
        "asset": "MNQ",
        "side": "long",
        "hold_bars": 15,
        "hold_class": "swing",
        ...
        "param_stability": 83,
        "session": "morning",
        "notes": "WF 6.7/10. MNQ-long PF=1.31, Sharpe=1.56, 107 trades. 83% window survival.",
        "primary_exposure": "gap_continuation",
        "secondary_exposure": "trend_persistence",
        "volatility_dependency": "neutral",
        "trend_dependency": "trending",
...
def print_report(data: dict) -> None:
    ...
    print(f"  {THIN}")
    for asset in ["MGC", "MNQ", "MES", "M2K", "MCL"]:
